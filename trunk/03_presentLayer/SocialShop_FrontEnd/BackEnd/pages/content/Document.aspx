...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="box_body">
        <div style="text-align: center; width: 100%; float: left; padding-top: 10px;">
            <a style="font-size: 24px;">Quản lý tài liệu</a>
        </div>
        ...
        <asp:Panel ID="Panel3" runat="server">
            <div class="box" id="divSearch" style="width: 940px; float: left;">
                ...
                <div class="content1" style="float: left; width: 960px;">
                    <table style="width: 960px; margin: auto; height: 70px;">
                        <tr>
                            <td>
                                Loại tài liệu
                            </td>
            ...
            <div class="doc_content" style="float: left; width: 100%;">
                ...
                Xóa
                    ...
                    <div class="content1" style="float: left; width: 960px; margin-bottom: 20px; padding-top: 20px;">
                        <asp:Repeater ID="RptDocument" runat="server" OnItemCommand="RptDocument_ItemCommand"
                            OnItemDataBound="RptDocument_ItemDataBound">
                            <HeaderTemplate>
                                <table cellspacing="0" class="tbl_doc" width="960" style="float: left;">
                                    <thead>
                                        <tr>
                                            <td style="width: 20px;">
                                            </td>
