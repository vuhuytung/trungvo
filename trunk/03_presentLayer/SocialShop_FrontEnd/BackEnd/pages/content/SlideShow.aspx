        ...
        <div class="box" style="width: 920px;">
            ...
            <div class="content">
                <asp:Repeater ID="RptSlide" runat="server" OnItemCommand="RptSlide_ItemCommand"
                    OnItemDataBound="RptSlide_ItemDataBound">
                    <HeaderTemplate>
                                            ...
                                            <ul class="context-menu">
                                                ...
                                                <li>
                                                    <asp:LinkButton ID="lbtDelete" runat="server" CssClass="delete_icon" ToolTip="Xóa"
                                                        OnClientClick="return ConfirmDelete()" CommandName="delete" CommandArgument='<%#Eval("ID") %>'
                                                        Text="Xóa">
                                                    </asp:LinkButton>
                                                </li>
                                                <%} %>
