<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucMenuTop.ascx.cs" Inherits="userControls_ucMenuTop" %>
<link rel="stylesheet" type="text/css" href="/css/menu/pro_dropdown_2.css" />
<script src="/css/menu/stuHover.js" type="text/javascript"></script>
<div class="menutop">
    ...
    <%--<ul id="nav">
        ...
        <li class="top"><a href="#nogo27" id="contacts" class="top_link"><span class="down">
            Contacts</span></a>
            <ul class="sub">
