...
namespace ComponentBLL
{
    public class Admin
    {
        ...
        {
            int? ret = 0;
            SocialShop.AdminInstance.uspCompanyNameExist(companyName, ref ret);
        ...
        {
            int? ret = 0;
            SocialShop.AdminInstance.uspCompanyNameUpdateExist(companyName, companyId, ref ret);
            return ret == 1 ? true : false;
        }
        ...
        {
            int? ret = 0;
            SocialShop.AdminInstance.uspCompanyExistEmail(email, ref ret);
            return ret == 1 ? true : false;
        }
        ...
        {
            int? ret = 0;
            SocialShop.AdminInstance.uspCompanyExistEmailUpdate(email, companyID, ref ret);
            return ret == 1 ? true : false;
        }
        ...
        {
            int? ret = 0;
            SocialShop.AdminInstance.uspCompanyExistChild(companyID, ref ret);
            return ret == 1 ? true : false;
        }
